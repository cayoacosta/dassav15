...
class CfdiTraslado(models.Model):
    ...
    partner_id = fields.Many2one('res.partner', string="Cliente", required=True, default=lambda self: self.env['res.company']._company_default_get('cfdi.traslado'))
    ...
    def to_json(self):
        ...
        request_params = {
                ...
                'receptor': {
                      ...
                      'ResidenciaFiscal': self.partner_id.cce_clave_pais.c_pais if self.partner_id.cce_clave_pais.c_pais != 'MEX' else '',
                      'NumRegIdTrib': self.partner_id.vat if self.partner_id.cce_clave_pais.c_pais != 'MEX' else '',
        ...
        for ubicacion in self.ubicaciones_line_ids:
            ...
            cp_ubicacion.append({
                          ...
                          # 'IDUbicacion': ubicacion.origen_id,
                            ...
                            'NumRegIdTrib': ubicacion.contacto.vat if ubicacion.contacto.cce_clave_pais.c_pais != 'MEX' else '',
                            'ResidenciaFiscal': ubicacion.contacto.cce_clave_pais.c_pais if ubicacion.contacto.cce_clave_pais.c_pais!= 'MEX' else '',
...
#           mercancia.update({'mercancia_detalle': mercancia_detalle})
        ...
        for figura in self.figuratransporte_ids:
            tipos_figura = {
                       ...
                       'NumRegIdTribFigura': figura.figura_id.vat if figura.figura_id.cce_clave_pais.c_pais!= 'MEX' else '',
    ...
    def send_factura_mail(self):
        self.ensure_one()
        template = self.env.ref('cfdi_traslado_ee.email_template_factura_traslado', False)
...
class MailTemplate(models.Model):
    ...
    def generate_email(self, res_ids, fields=None):
        ...
        for lang, (template, template_res_ids) in self._classify_per_lang(res_ids).items():
            if template.report_template and template.report_template.report_name == 'cfdi_traslado_ee.email_template_factura_traslado':
